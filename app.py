...
def dashboard():
    ...
    what_it_does = '''
    The Edmonton Food Drive Enhancement Project has been in progress from September 2023 to December 2023. It involves various stages starting with collecting data and moving through cleaning, analyzing, developing machine learning models, integrating maps, creating an AI-powered application, and engaging stakeholders actively. Each phase significantly contributes to improving food donation logistics helping in the betterment of process.
    '''
...
def exploratory_data_analysis():
    ...
    fig = px.histogram(data_cleaned, x='# of Adult Volunteers', color_discrete_sequence=px.colors.qualitative.Set1, nbins=20, labels={'# of Adult Volunteers': 'Adult Volunteers'})
    st.plotly_chart(fig)
